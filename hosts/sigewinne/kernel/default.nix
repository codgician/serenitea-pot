{ mobile-nixos, fetchpatch, kernel, ... }: mobile-nixos.kernel-builder {
  ...
  patches = [
    ...
    # Add register names and sys
    (fetchpatch {
      url = "https://gitlab.com/postmarketOS/pmaports/-/raw/497374e29085c6bfaa2a95113cd65a5719274cca/device/community/linux-postmarketos-mediatek-mt8183/arm64-dts-mediatek-mt8183-Add-register-names-and-sys.patch";
      sha256 = "sha256-+7wx0XVKr9nCJc4JWQMrLbX3V2iq+i/3M2rr9z+n50w=";
    })

    # Drop vdec sys register
    (fetchpatch {
      url = "https://gitlab.com/postmarketOS/pmaports/-/raw/497374e29085c6bfaa2a95113cd65a5719274cca/device/community/linux-postmarketos-mediatek-mt8183/arm64-dts-mediatek-mt8183-Drop-VDEC_SYS-register.patch";
      sha256 = "sha256-fCsjl9jQGezkqZOzftXEil5IF7DWTxbMQUIhgPBysBs=";
    })
  ];
