{ ... }:
{
  ...
  clients = [
    ...
    }
    {
      client_id = "gitlab";
      client_name = "GitLab";
      client_secret = "$pbkdf2-sha512$310000$.xucd49OxRoMf2eW3pyRMw$gpCOt/cv/EmYMtiu6Zk0h2OYdReXywjB7YXjYvnaW9zR4F8pj9bQxeZaJiNlVZlZjiH7BZww7JyG1hCleFgSHA";
      public = false;
      authorization_policy = "two_factor";
      require_pkce = true;
      pkce_challenge_method = "S256";
      redirect_uris = [
        "https://git.codgician.me/users/auth/openid_connect/callback"
      ];
      scopes = [
        "openid"
        "profile"
