{ config, lib }: with lib.codgician; {
  ...
  allowedIPs = [ "192.168.254.1/32" "fd00:c0d9:1cff::1/128" "192.168.0.0/24" "fd00:c0d9:1c00::/48" ];
  ...
  ageFilePaths = builtins.map getAgeSecretPathFromName [ "wgLumidoucePrivateKey" "wgPresharedKey" ];
}
